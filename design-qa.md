...
- Chat gallery and selected-session states: `/private/tmp/FirmDeck-sd1-qa/01-chat-gallery-switch.png` through `/private/tmp/FirmDeck-sd1-qa/15-chat-stopped-or-idle.png`
- Figma reference exports: `/private/tmp/FirmDeck-figma-sd1/01-figma-1-2892.png` through `/private/tmp/FirmDeck-figma-sd1/15-figma-1-5409.png`
- Visual comparison contact sheet: `/private/tmp/FirmDeck-sd1-visual-diff/overview-15-scenarios.png`
- Visual comparison report: `/private/tmp/FirmDeck-sd1-visual-diff/visual-diff-report.json`
- Enterprise employee roster: `/private/tmp/FirmDeck-sd1-qa/02-enterprise-agents-collapsed.png` (legacy filename; Figma node `1:765` is expanded), `/private/tmp/FirmDeck-sd1-qa/05-enterprise-agents-expanded.png`, `/private/tmp/FirmDeck-sd1-qa/09-enterprise-agents-collapsed-reference.png`
- Enterprise employee profile: `/private/tmp/FirmDeck-sd1-qa/06-enterprise-dashboard-expanded.png`, `/private/tmp/FirmDeck-sd1-qa/10-enterprise-dashboard-collapsed.png`
- Dark and responsive checks: `/private/tmp/FirmDeck-sd1-qa/20-dark-chat-input.png`, `/private/tmp/FirmDeck-sd1-qa/21-dark-enterprise-dashboard.png`, `/private/tmp/FirmDeck-sd1-qa/22-mobile-chat-input.png`, `/private/tmp/FirmDeck-sd1-qa/23-mobile-enterprise-agents.png`
- Machine-readable report: `/private/tmp/FirmDeck-sd1-qa/report.json`
