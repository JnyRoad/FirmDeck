...
type FirmdeckIconProps = {
  name: FirmdeckIconName;
  className?: string;
  size?: number;
  style?: CSSProperties;
};

const iconPaths: Record<FirmdeckIconName, string[]> = {
  arrow: ['M9 5l6 7-6 7'],
...
export default function FirmdeckIcon({ name, className = '', size = 18, style }: FirmdeckIconProps) {
  return (
    <svg
